...
int main()
{
    ...
    while (1) {
        printf("Choose the type of chart:\n");
        printf("1. Pie Chart\n");
        printf("2. Bar Graph\n");
    ...
    while (1)
    {
        ...
        printf("Enter the title of the chart: ");
        ...
        if (chart_type == 1) {
            // Print the pie chart
            print_pie_chart(title, categories, num_categories);
        } else {
        ...
        while (1)
        {
            ...
            case 1:
                ...
                if (chart_type == 1) {
                    ...
                    print_pie_chart_to_file(filePointer, title, categories, num_categories);
                } else {
            ...
            case 2:
                ...
                if (chart_type == 1) {
                    // Print updated pie chart
                    print_pie_chart(title, categories, num_categories);
                } else {
                    // Print updated horizontal bar chart
                    print_horizontal_bar_chart(title, categories, num_categories, x_axis_label);
                }
                break;
            case 3:
